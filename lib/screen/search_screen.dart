    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            Padding(
              ...
              child: Container(
                ...
                child: TextField(autofocus: false, decoration: InputDecoration(
                  hintText: 'Cari Candi..',
          ...
          ListView.builder(
            itemCount: _filteredCandis.length, itemBuilder: (context, index){
              final candi = _filteredCandis[index];
              return Card(margin: EdgeInsets.symmetric(horizontal: 16, vertical: 4),
              child:
                Row(
